...
public class Level4StateB extends GameState {
	...
	public Level4StateB (GameStateManager gsm) {
		this.gsm = gsm;
		init();
	}
	...
	public void init () {
		...
		tileMap.loadMap("/Maps/mapa4b.map");
...
//		}
		if(player.getButton())
		{
			...
			gsm.setState(GameStateManager.LEVEL4STATEC);
		}
	...
	public void keyPressed (int k) {
		...
		if(k==KeyEvent.VK_B)
		{
			gsm.setPreviousState(GameStateManager.LEVEL4STATEB);
