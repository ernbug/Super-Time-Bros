...
public class Level4StateA extends GameState {
	...
	public Level4StateA (GameStateManager gsm) {
		this.gsm = gsm;
		init();
	}
	...
	public void init () {
		...
		tileMap.loadMap("/Maps/mapa4a.map");
...
//		}
		if(player.getButton())
		{
			...
			gsm.setState(GameStateManager.LEVEL4STATEB);
		}
